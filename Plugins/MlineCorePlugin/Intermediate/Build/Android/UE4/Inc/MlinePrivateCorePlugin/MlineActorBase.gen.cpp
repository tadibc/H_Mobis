...
static struct FScriptStruct_MlinePrivateCorePlugin_StaticRegisterNativesFAutonomousReplicatedMovemant
{
	...
	uint32 Get_Z_Construct_UScriptStruct_FAutonomousReplicatedMovemant_Hash() { return 4116930562U; }
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AMlineActorBase_Statics::NewProp_bIsPhysicsActor_MetaData[] = {
		{ "Category", "Replication" },
		{ "ModuleRelativePath", "Public/MlineActorBase.h" },
	};
#endif
	void Z_Construct_UClass_AMlineActorBase_Statics::NewProp_bIsPhysicsActor_SetBit(void* Obj)
	{
		((AMlineActorBase*)Obj)->bIsPhysicsActor = 1;
	}
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_AMlineActorBase_Statics::NewProp_bIsPhysicsActor = { "bIsPhysicsActor", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(AMlineActorBase), &Z_Construct_UClass_AMlineActorBase_Statics::NewProp_bIsPhysicsActor_SetBit, METADATA_PARAMS(Z_Construct_UClass_AMlineActorBase_Statics::NewProp_bIsPhysicsActor_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AMlineActorBase_Statics::NewProp_bIsPhysicsActor_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_AMlineActorBase_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AMlineActorBase_Statics::NewProp_bIsPhysicsActor,
	};
	...
	IMPLEMENT_CLASS(AMlineActorBase, 3764899006);
