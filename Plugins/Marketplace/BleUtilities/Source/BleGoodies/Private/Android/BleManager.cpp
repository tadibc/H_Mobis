...
void UBleManager::Init()
{
	...
	//GetDeviceNameListMethod = BleManagerJObject->GetClassMethod("getPairedDeviceNameList", "()Ljava/util/List;");
	//GetDeviceListMethod = BleManagerJObject->GetClassMethod("getPairedDeviceList", "()Ljava/util/List;");
}

/*
List<String> UBleManager::GetDeviceNameList()
{
	return BleManagerJObject->CallMethod<List<String>>(GetDeviceNameListMethod);
}

List<BluetoothDevice> UBleManager::GetDeviceList()
{
	return BleManagerJObject->CallMethod<List<BluetoothDevice>>(GetDeviceNameListMethod);
}
*/
